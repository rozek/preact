		...
		try {
			if (
				...
				C &&
					...
					w(h.__s, F.getDerivedStateFromProps(b, h.__s))),
				(v = h.props),
				(y = h.state),
				(h.__v = u),
				p)
...
function q(n, u, t) {
	...
	if (
		...
		(i = n.ref) && ((i.current && i.current !== n.__e) || V(i, null, u)),
		null != (i = n.__c))
	) {
	...
	if ((i = n.__k))
		for (r = 0; r < i.length; r++)
			i[r] && q(i[r], u, t || 'function' != typeof n.type);
...
function G(l, u, t) {
	...
	for (o in (l.type && l.type.defaultProps && (e = l.type.defaultProps), u))
		'key' == o
			...
			: 'ref' == o
				? (r = u[o])
				: (f[o] = void 0 === u[o] && void 0 !== e ? e[o] : u[o]);
	return (
		arguments.length > 2 &&
